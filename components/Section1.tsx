            ...
            <section className="section1">
                ...
                <div className="section1-vertical">
                    ...
                    <div className="button-container">
                        <button className="blue-button" onClick={() => window.open("https://discord.com/oauth2/authorize?client_id=593838271650332672&permissions=2113793271&scope=bot", "_blank")}><span className="section1-text button-text">Invite</span></button>
